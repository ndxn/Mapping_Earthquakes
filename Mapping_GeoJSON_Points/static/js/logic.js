...
let airportData = "https://raw.githubusercontent.com/ndxn/Mapping_Earthquakes/master/majorAirports.json";
...
d3.json(airportData).then(function(data) {
    ...
    L.geoJson(data, {
        onEachFeature: function(feature, layer) {
          layer.bindPopup("<h3>Airpot code: " + feature.properties.faa + "</h3> <hr><h3></h3>Airpot name: " + feature.properties.name + " " + feature.properties.country + "</h3> ");
         }
      })
    .addTo(map);
});
